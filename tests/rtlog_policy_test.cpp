...
int main()
{
    ...
    const LogPolicyTarget targets[] = {
        ...
        {"deployment/tests/main.cpp", 1, 0},
        {"lua/testing/testcomp.cpp", 1, 0},
        {"timer/tests/main.cpp", 1, 0},
        {"timer/tests/testWithStateMachine.cpp", 1, 0},
        {"taskbrowser/tests/main.cpp", 1, 0},
        {"reporting/tests/main.cpp", 1, 0},
        {"reporting/tests/tcpmain.cpp", 1, 0},
        {"reporting/tests/ncmain.cpp", 1, 0},
        {"logging/tests/TestComponent.cpp", 1, 0},
        {"logging/tests/TestLoggingAvailability.cpp", 1, 0},
