...
FOREACH(COMPONENT ${RTTPlugin_FIND_COMPONENTS})
    ...
    if(RTT_PLUGIN_${COMPONENT}_${OROCOS_TARGET}_LIBRARY AND RTT_PLUGIN_${COMPONENT}_${OROCOS_TARGET}D_LIBRARY)
        ...
        set(RTT_PLUGIN_${COMPONENT}_LIBRARIES ${RTT_PLUGIN_${COMPONENT}_LIBRARY})
        set(RTT_PLUGIN_${COMPONENT}_${OROCOS_TARGET}_LIBRARIES ${RTT_PLUGIN_${COMPONENT}_${OROCOS_TARGET}_LIBRARY})
    endif()
